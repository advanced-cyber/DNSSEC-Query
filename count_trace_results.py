...
if __name__ == "__main__":
    ...
    with open(new_csv_insecure, 'w') as csv_file:
        fieldnames = ['TLD', 'Middle_End']
        writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
        writer.writeheader()
        writer.writerow({'TLD': counter_insecure[0], 'Middle_End': counter_insecure[1]})
    csv_file.close()
